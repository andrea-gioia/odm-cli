package org.opendatamesh.odm.cli.commands.blueprint.subcommands;
...
public class InitBlueprintCommand implements Runnable {
    ...
    public void run() {
        ...
        try {
            blueprintResourceResponseEntity = blueprintCommands.getConfig().getBlueprintServiceClient().readOneBlueprint(blueprintId);
            if (blueprintResourceResponseEntity.getStatusCode().equals(HttpStatus.OK)){
                ...
                ResponseEntity<Void> blueprintResponseEntity =
                        blueprintCommands.getConfig().getBlueprintServiceClient().instanceBlueprint(blueprintId, configResource);
