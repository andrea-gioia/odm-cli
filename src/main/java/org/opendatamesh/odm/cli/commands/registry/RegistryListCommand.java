...
public class RegistryListCommand implements Runnable {
    ...
    public void listDataProducts() {
        try {
            ResponseEntity<DataProductResource[]> dataProductResourceResponseEntity = registryCommands
                    .getRegistryClient().getDataProducts();
    ...
    public void listDataProductVerions() {
        try {
            ...
            ResponseEntity<DataProductResource> dataProductResourceResponseEntity = registryCommands
                    .getRegistryClient().getDataProduct(dataProductId);
            ...
            ResponseEntity<String[]> dataProductVersionsResponseEntity = registryCommands
                    .getRegistryClient().getDataProductVersions(dataProductId);
