...
public class RegistryGetCommand implements Runnable {
    ...
    @Option(names = "--dp-id", description = "Version of the data product", required = false)
    ...
    public void getDataProduct() {
        try {
            ResponseEntity<DataProductResource> dataProductResponseEntity = registryCommands.getRegistryClient()
                    .getDataProduct(dataProductId);
    ...
    public void getDataProductVerion() {
        try {
            ResponseEntity<DataProductVersionDPDS> dataProductVersionsResponseEntity = registryCommands
                    .getRegistryClient().getDataProductVersion(
